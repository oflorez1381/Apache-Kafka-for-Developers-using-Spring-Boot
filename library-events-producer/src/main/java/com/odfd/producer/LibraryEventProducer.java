...
public class LibraryEventProducer {
    ...
    private void handleFailure(Integer key, String value, Throwable ex) {
        log.error("Error sending the Message for the key : {} , the value is {} and the exception is {} ",
    ...
    private void handleSuccess(Integer key, String value, SendResult<Integer, String> result) {
        log.info("Message sent successfully for the key : {} , the value is {} and partition is {} ",
    ...
    public SendResult<Integer, String> sendLibraryEventSynchronous(LibraryEvent libraryEvent) throws JsonProcessingException, ExecutionException, InterruptedException, TimeoutException {
        ...
        try {
            ...
            log.error("ExecutionException | InterruptedException sending the message amd the exception is {}", e.getMessage());
            throw e;
        } catch (Exception e) {
            log.error("Exception sending the message amd the exception is {}", e.getMessage());
            throw e;
        }
        return sendResult;
    }
